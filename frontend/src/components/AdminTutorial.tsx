...
import type { AdminTutorialStep, TutorialPosition } from "@/lib/adminTutorialSteps";
...
export function AdminTutorial({ steps, currentStep, onNext, onSkipStep, onSkipAll }: Props) {
