...
import { ChevronLeft, ChevronRight, StickyNote, AlertTriangle } from "lucide-react";
...
export function AuditFindingList({ findings, selectedId, onSelect, businessMode }: Props) {
        ...
        {pageItems.map((finding) => {
          ...
          return (
            <button
              ...
              className={clsx(
                "w-full text-left px-4 py-3 transition-colors hover:bg-ink/[0.03]",
